...
async function agentsConnectionReport(userSelection) {
  // if (userSelection.agent) {

  //   return agentsConnectionReportDetail(userSelection);
  // } else {
...
// async function agentsConnectionReportDetail(userSelection){
...
//       ,(id_break) as times_registered
//       ,(audit_date) as min_date
//       ,(audit_date) as max_date
//       ,(DATE_FORMAT(audit_datetime_init, '%H:%i:%s')) as start_time
//       ,(DATE_FORMAT(audit_datetime_end_full, '%H:%i:%s')) as end_time
