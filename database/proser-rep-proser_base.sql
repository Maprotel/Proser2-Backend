...
--
-- Database: `proser-rep-proser_base`
--
...
CREATE TABLE `MainAudit` (
  ...
  `audit_datetime_end` varchar(150) COLLATE utf8_spanish_ci DEFAULT NULL,
...
--
-- Table structure for table `MainCallEntry`
--
...
--
-- Table structure for table `MainQueueLog`
--
...
--
-- Table structure for table `MainStoredQueries`
--
...
--
-- Table structure for table `RealAudit`
--
...
CREATE TABLE `RealAudit` (
  ...
  `audit_break_id` int(10) DEFAULT NULL,
  `audit_datetime_init` datetime DEFAULT NULL,
  `audit_datetime_end` text COLLATE utf8_spanish_ci DEFAULT NULL,
  `audit_duration` time DEFAULT NULL,
  `audit_ext_parked` varchar(10) COLLATE utf8_spanish_ci DEFAULT NULL,
  `__TIME__` int(10) DEFAULT NULL,
  `audit_duration_sec` int(10) DEFAULT NULL,
...
--
-- Table structure for table `RealCallEntry`
--
...
--
-- Table structure for table `RealCdr`
--
...
--
-- Table structure for table `RealCurrentAgents`
--
...
--
-- Table structure for table `RealCurrentBreaks`
--
...
--
-- Table structure for table `RealCurrentCalls`
--
...
--
-- Table structure for table `RealQueueLog`
--
...
--
-- Table structure for table `test.MainAudit`
--

DROP TABLE IF EXISTS `test.MainAudit`;
CREATE TABLE `test.MainAudit` (
  `audit_id` int(10) NOT NULL,
  `audit_agent_id` int(10) DEFAULT NULL,
  `audit_break_id` int(10) DEFAULT NULL,
  `audit_datetime_init` datetime DEFAULT NULL,
...
--
-- Indexes for table `MainCallEntry`
--
...
--
-- Indexes for table `MainQueueLog`
--
...
--
-- Indexes for table `MainStoredQueries`
--
...
--
-- Indexes for table `RealCallEntry`
--
...
--
-- Indexes for table `RealCurrentAgents`
--
...
--
-- Indexes for table `RealCurrentBreaks`
--
...
--
-- Indexes for table `RealCurrentCalls`
--
...
--
-- Indexes for table `RealQueueLog`
--
...
--
-- Indexes for table `test.MainAudit`
--
ALTER TABLE `test.MainAudit`
  ADD PRIMARY KEY (`audit_id`),
  ADD KEY `audit_date` (`audit_date`),
  ADD KEY `id_break` (`audit_break_id`),
  ADD KEY `id_agent` (`audit_agent_id`),
...
--
-- AUTO_INCREMENT for table `MainStoredQueries`
--
ALTER TABLE `MainStoredQueries`
