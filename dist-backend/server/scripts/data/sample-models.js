...
module.exports = function (app) {
  ...
  User.create([{
    ...
    if (err) throw err;
    console.log('Created users:', users); // create project 1 and make john the owner
    ...
    users[0].projects.create({
      ...
      if (err) throw err;
      console.log('Created project:', project); // add team members
    ...
    Role.create({
      ...
      if (err) throw err;
      console.log('Created role:', role); //make bob an admin
