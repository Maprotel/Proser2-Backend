...
var destinyTable = "HcaQueue";
var destinyDateField = "";
var destinyStatusField = "hca_queue_status";
var originTable = "HcaQueue";
var originDateField = "";
var originStatusField = "hca_queue_status";
var first_pass = true;
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            result = null;
            querySQL = "\n      SELECT\n      *\n      FROM HcaQueue\n      WHERE hca_queue_date = '".concat(start_date, "'\n      ");
            _context.prev = 2;
            console.log("reading...");
            _context.next = 6;
...
function duplicateHcaQueue(_x2, _x3) {
  return _duplicateHcaQueue.apply(this, arguments);
}
/************************************************************************ */


function _duplicateHcaQueue() {
  _duplicateHcaQueue = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return readOrigin(start_date)["catch"](function (err) {
              return console.log("duplicateHcaQueue error - readOrigin", err);
            });
          ...
          case 6:
            ...
            return (0, _duplicate_functions.writeDestiny)(extendedResult, destinyTable)["catch"](function (err) {
              return console.log("duplicateHcaQueue caught it - writeDestiny", err);
            });

          case 15:
            written = _context2.sent;
            console.log("Finished");
            return _context2.abrupt("return", "duplicateHcaQueue end");
...
module.exports = {
  duplicateHcaQueue: duplicateHcaQueue
};