...
function extractMain(_x) {
  return _extractMain.apply(this, arguments);
} // Find minimun date in Origin Cdr


function _extractMain() {
  _extractMain = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
        ...
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            try {
              ...
              setInterval(function () {
                console.log("**** ".concat(incoming_date, " -- ").concat(min_date, "  ********"));
                extractMain(incoming_date);
