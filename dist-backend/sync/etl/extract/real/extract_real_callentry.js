...
// Constants
var destinyTable = "RealCallEntry";
var originTable = "MainCallEntry";
var datefield = "callentry_datetime_entry_queue";
var incoming_date = process.argv[2];
/******************* Running actual program -- exec*/

function extractRealCallEntry(_x) {
  return _extractRealCallEntry.apply(this, arguments);
}
/************************************************************************ */
...
function _extractRealCallEntry() {
  _extractRealCallEntry = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
        ...
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            return (0, _extractFunctionsReal.writeDestiny)(extendedResult, destinyTable)["catch"](function (err) {
              return console.log("extractRealCallEntry caught it - writeDestiny", err);
            });

          case 14:
            written = _context.sent;
            return _context.abrupt("return", {
              "function": "extractRealCallEntry ",
              result: written
            });
...
module.exports = {
  extractRealCallEntry: extractRealCallEntry
};