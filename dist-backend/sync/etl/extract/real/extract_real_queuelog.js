...
// Constants
var destinyTable = "RealQueueLog";
var originTable = "MainQueueLog";
var datefield = "queuelog_time";
var incoming_date = process.argv[2];
/******************* Running actual program -- exec*/

function extractRealQueueLog(_x) {
  return _extractRealQueueLog.apply(this, arguments);
}
/************************************************************************ */
...
function _extractRealQueueLog() {
  _extractRealQueueLog = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
        ...
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            return (0, _extractFunctionsReal.writeDestiny)(extendedResult, destinyTable)["catch"](function (err) {
              return console.log("extractRealQueueLog caught it - writeDestiny", err);
            });

          case 14:
            written = _context.sent;
            return _context.abrupt("return", {
              "function": "extractRealQueueLog ",
              result: written
            });
...
module.exports = {
  extractRealQueueLog: extractRealQueueLog
};