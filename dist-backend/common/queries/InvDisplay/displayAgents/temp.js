...
exports.displayAgentsIndicators = displayAgentsIndicators;
...
/******************************************************************** */
// MAIN FUNCTION
function displayAgentsIndicators(_x) {
  return _displayAgentsIndicators.apply(this, arguments);
}
/**************************************** */
// indicators


function _displayAgentsIndicators() {
  _displayAgentsIndicators = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  _regenerator["default"].mark(function _callee(userSelection) {
    var result, resume_error, displayAgentsCallsIndicators, displayAgentsCurrentCallsIndicators, agentsPlannedTotal, agentsConnectedTotal, agentsLoggedTotal, agentsConnectedByGroup, agentHistoricResume, agentsAuxiliarResume, agentsAssignationResume, agentsHistoricBreakResume, agentsHistoricAssignationResume, scale, colors;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return displayAgentsCallsIndicatorsFunction(userSelection);

          case 5:
            displayAgentsCallsIndicators = _context.sent;
            _context.next = 8;
            return displayAgentsCurrentCallsIndicatorsFunction(userSelection);

          case 8:
            displayAgentsCurrentCallsIndicators = _context.sent;
            _context.next = 11;
          ...
          case 38:
            ...
            if (Array.isArray(displayAgentsCallsIndicators) & typeof displayAgentsCallsIndicators[0] !== "undefined") {
              console.log("displayAgentsCallsIndicators", displayAgentsCallsIndicators);
              colors = [{
                AgentsServiceLevel: (0, _scaleFunctions.onColorForPercentage)(displayAgentsCallsIndicators[0].AgentsServiceLevel, scale[0]),
                AgentsAttentionLevel: (0, _scaleFunctions.onColorForPercentage)(displayAgentsCallsIndicators[0].AgentsAttentionLevel, scale[0]),
                AgentsAbandonLevel: (0, _scaleFunctions.onColorForPercentage)(displayAgentsCallsIndicators[0].AgentsAbandonLevel, scale[0]),
                callsOnQueue: (0, _scaleFunctions.onColorForCallsOnQueue)(displayAgentsCurrentCallsIndicators[0].maxWaitTimeOnQue, parseInt(process.env.CDR_SERVICE_IDEAL_TIME)),
                callsOnQueueIdeal: parseInt(process.env.CDR_SERVICE_IDEAL_TIME),
                callsOnQueueWaitTime: displayAgentsCurrentCallsIndicators[0].maxWaitTimeOnQue
              }];
            }

            result = {
              displayAgentsCallsIndicators: displayAgentsCallsIndicators,
              displayAgentsCurrentCallsIndicators: displayAgentsCurrentCallsIndicators,
...
function displayAgentsCallsIndicatorsFunction(_x2) {
  return _displayAgentsCallsIndicatorsFunction.apply(this, arguments);
}
/**************************************** */
// current calls


function _displayAgentsCallsIndicatorsFunction() {
  _displayAgentsCallsIndicatorsFunction = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
...
function displayAgentsCurrentCallsIndicatorsFunction(_x3) {
  return _displayAgentsCurrentCallsIndicatorsFunction.apply(this, arguments);
}
/**************************************** */
// Agents planned


function _displayAgentsCurrentCallsIndicatorsFunction() {
  _displayAgentsCurrentCallsIndicatorsFunction = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
