...
exports.displayOutboundIndicators = displayOutboundIndicators;
...
/******************************************************************** */
// MAIN FUNCTION
function displayOutboundIndicators(_x) {
  return _displayOutboundIndicators.apply(this, arguments);
}
/**************************************** */
// indicators


function _displayOutboundIndicators() {
  _displayOutboundIndicators = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  _regenerator["default"].mark(function _callee(userSelection) {
    var result, resume_error, displayOutboundCallsIndicators, displayOutboundCurrentCallsIndicators, agentsPlannedTotal, agentsConnectedTotal, agentsLoggedTotal, agentsConnectedByGroup, agentHistoricResume, agentsAuxiliarResume, agentsAssignationResume, agentsHistoricBreakResume, agentsHistoricAssignationResume, scale, colors;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            resume_error = false;
            _context.next = 4;
            return displayOutboundCallsIndicatorsFunction(userSelection);

          case 4:
            displayOutboundCallsIndicators = _context.sent;
            _context.next = 7;
            return displayOutboundCurrentCallsIndicatorsFunction(userSelection);

          case 7:
            displayOutboundCurrentCallsIndicators = _context.sent;
            _context.next = 10;
          ...
          case 31:
            scale = _context.sent;
            colors = [{
              outboundContactLevel: (0, _scaleFunctions.onColorForPercentage)(displayOutboundCallsIndicators[0].outboundContactLevel, scale[0]),
              outboundEffectiveLevel: (0, _scaleFunctions.onColorForPercentage)(displayOutboundCallsIndicators[0].outboundEffectiveLevel, scale[0]),
              callsOnQueue: (0, _scaleFunctions.onColorForCallsOnQueue)(displayOutboundCurrentCallsIndicators[0].maxWaitTimeOnQue, parseInt(process.env.CDR_SERVICE_IDEAL_TIME)),
              callsOnQueueWaitTime: displayOutboundCurrentCallsIndicators[0].maxWaitTimeOnQue,
              callsOnQueueIdeal: parseInt(process.env.CDR_SERVICE_IDEAL_TIME)
            }];
            result = {
              displayOutboundCallsIndicators: displayOutboundCallsIndicators,
              displayOutboundCurrentCallsIndicators: displayOutboundCurrentCallsIndicators,
...
function displayOutboundCallsIndicatorsFunction(_x2) {
  return _displayOutboundCallsIndicatorsFunction.apply(this, arguments);
}
/**************************************** */
// current calls


function _displayOutboundCallsIndicatorsFunction() {
  _displayOutboundCallsIndicatorsFunction = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
...
function displayOutboundCurrentCallsIndicatorsFunction(_x3) {
  return _displayOutboundCurrentCallsIndicatorsFunction.apply(this, arguments);
}
/**************************************** */
// Agents planned


function _displayOutboundCurrentCallsIndicatorsFunction() {
  _displayOutboundCurrentCallsIndicatorsFunction = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
