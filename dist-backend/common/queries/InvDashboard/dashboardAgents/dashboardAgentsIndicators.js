...
exports.dashboardAgentsIndicators = dashboardAgentsIndicators;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return dashboardAgentsCallsIndicatorsFunction(userSelection);

          case 5:
            dashboardAgentsCallsIndicators = _context.sent;
            _context.next = 8;
            return dashboardAgentsCurrentCallsIndicatorsFunction(userSelection);

          case 8:
            dashboardAgentsCurrentCallsIndicators = _context.sent;
            _context.next = 11;
          ...
          case 38:
            scale = _context.sent;
            colors = [{
              AgentsServiceLevel: (0, _scaleFunctions.onColorForPercentage)(dashboardAgentsCallsIndicators[0].AgentsServiceLevel, scale[0]),
              AgentsAttentionLevel: (0, _scaleFunctions.onColorForPercentage)(dashboardAgentsCallsIndicators[0].AgentsAttentionLevel, scale[0]),
              AgentsAbandonLevel: (0, _scaleFunctions.onColorForPercentage)(dashboardAgentsCallsIndicators[0].AgentsAbandonLevel, scale[0]),
              callsOnQueue: (0, _scaleFunctions.onColorForCallsOnQueue)(dashboardAgentsCurrentCallsIndicators[0].maxWaitTimeOnQue, parseInt(process.env.CDR_SERVICE_IDEAL_TIME)),
              callsOnQueueWaitTime: dashboardAgentsCurrentCallsIndicators[0].maxWaitTimeOnQue,
              callsOnQueueIdeal: parseInt(process.env.CDR_SERVICE_IDEAL_TIME)
            }];
            result = {
              dashboardAgentsCallsIndicators: dashboardAgentsCallsIndicators,
              dashboardAgentsCurrentCallsIndicators: dashboardAgentsCurrentCallsIndicators,
...
function dashboardAgentsCallsIndicatorsFunction(_x2) {
  return _dashboardAgentsCallsIndicatorsFunction.apply(this, arguments);
}
/**************************************** */
// current calls


function _dashboardAgentsCallsIndicatorsFunction() {
  _dashboardAgentsCallsIndicatorsFunction = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
...
function dashboardAgentsCurrentCallsIndicatorsFunction(_x3) {
  return _dashboardAgentsCurrentCallsIndicatorsFunction.apply(this, arguments);
}
/**************************************** */
// Agents planned


function _dashboardAgentsCurrentCallsIndicatorsFunction() {
  _dashboardAgentsCurrentCallsIndicatorsFunction = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
