...
exports.dashboardInboundIndicatorsRealTime = dashboardInboundIndicatorsRealTime;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            resume_error = false;
            _context.next = 4;
            return dashboardInboundCallsIndicatorsFunction(userSelection);

          case 4:
            dashboardInboundCallsIndicators = _context.sent;
            _context.next = 7;
            return dashboardInboundCurrentCallsIndicatorsFunction(userSelection);

          case 7:
            dashboardInboundCurrentCallsIndicators = _context.sent;
            _context.next = 10;
          ...
          case 31:
            scale = _context.sent;
            colors = [{
              inboundServiceLevel: (0, _scaleFunctions.onColorForPercentage)(dashboardInboundCallsIndicators[0].inboundServiceLevel, scale[0]),
              inboundAttentionLevel: (0, _scaleFunctions.onColorForPercentage)(dashboardInboundCallsIndicators[0].inboundAttentionLevel, scale[0]),
              inboundAbandonLevel: (0, _scaleFunctions.onColorForPercentage)(dashboardInboundCallsIndicators[0].inboundAbandonLevel, scale[0]),
              callsOnQueue: (0, _scaleFunctions.onColorForCallsOnQueue)(dashboardInboundCurrentCallsIndicators[0].maxWaitTimeOnQue, parseInt(process.env.CDR_SERVICE_IDEAL_TIME)),
              callsOnQueueWaitTime: dashboardInboundCurrentCallsIndicators[0].maxWaitTimeOnQue,
              callsOnQueueIdeal: parseInt(process.env.CDR_SERVICE_IDEAL_TIME)
            }];
            result = {
              dashboardInboundCallsIndicators: dashboardInboundCallsIndicators,
              dashboardInboundCurrentCallsIndicators: dashboardInboundCurrentCallsIndicators,
...
function dashboardInboundCallsIndicatorsFunction(_x2) {
  return _dashboardInboundCallsIndicatorsFunction.apply(this, arguments);
}
/**************************************** */
// current calls


function _dashboardInboundCallsIndicatorsFunction() {
  _dashboardInboundCallsIndicatorsFunction = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
...
function dashboardInboundCurrentCallsIndicatorsFunction(_x3) {
  return _dashboardInboundCurrentCallsIndicatorsFunction.apply(this, arguments);
}
/**************************************** */
// Agents planned


function _dashboardInboundCurrentCallsIndicatorsFunction() {
  _dashboardInboundCurrentCallsIndicatorsFunction = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
