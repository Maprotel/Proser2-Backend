...
exports.dashboardInboundListCurrentBreaks = dashboardInboundListCurrentBreaks;
...
/**************************************** */
// Call Entry List
function dashboardInboundListCurrentBreaks(_x) {
  return _dashboardInboundListCurrentBreaks.apply(this, arguments);
}

function _dashboardInboundListCurrentBreaks() {
  _dashboardInboundListCurrentBreaks = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            type = DashboardSelection.type; // if(userSelection.mode.name='Actual'){
